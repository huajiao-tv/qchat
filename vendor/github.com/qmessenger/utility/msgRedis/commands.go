...
/********************************geo**************************************/
func (c *Conn) GEOADD(key string, lon,lat float64, member string) (int64, error) {
	...
	n, e := c.CallN(RetryTimes, "GEOADD", args...)
	if e != nil {
		return -1, e
	}
...
func (c *Conn) GEORADIUS(key string, lon,lat,radius float64, count int64) ([]interface{}, error) {
	...
	v, e := c.CallN(RetryTimes, "GEORADIUS", args...)
	if e != nil {
		return nil, e
	}
